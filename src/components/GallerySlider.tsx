...
import SlideCanvas from '../file/SlideCanvas';
import Particles from '../file/Particles';
import TitlesContainer from '../file/TitlesContainer';
import Footer from '../file/Footer';
import '../file/global.css';
import '../file/canvas.css';
import '../file/particles.css';
import '../file/titles.css';
import '../file/footer.css';
